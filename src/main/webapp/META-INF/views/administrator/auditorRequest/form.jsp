...
<acme:form>
	...
	<acme:form-select code="administrator.auditorRequest.form.label.status" path="status">
		<acme:form-option code="administrator.auditorRequest.form.label.status.pending" value="pending" selected="true"/>
		<acme:form-option code="administrator.auditorRequest.form.label.status.accepted" value="accepted"/>
