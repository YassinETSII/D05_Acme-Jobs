...
<acme:form>
	...
	<jstl:if test="${finalMode == false || finalMode == true && command == 'update' || finalMode == true && command == 'create'}">
	...
	<jstl:if test="${finalMode == true && command != 'update' && finalMode == true && command != 'create'}">
